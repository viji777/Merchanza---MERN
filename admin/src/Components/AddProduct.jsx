...
const AddProduct = () => {
  ...
  const Add_Product = async () => {
    ...
    await fetch("https://merchanza-bend.onrender.com/upload", {
      method: "POST",
      headers: {
    ...
    if (responseData.success) {
      ...
      console.log(product);
      await fetch("https://merchanza-bend.onrender.com/addproduct", {
        method: "POST",
        headers: {
          Accept: "application/json",
    ...
    <div className="p-8 box-border bg-white w-full rounded-sm mt-5 lg:ml-5 ">
      <div className="mb-3 ">
        ...
        <input
          ...
          className="bg-primary  outline-none max-w-80 w-full
      ...
      <div className="mb-3 flex items-center gap-x-4 ">
        ...
        <select
          name="category"
          id=""
          className="bg-primary ring-1 ring-slate-900/20 medium-16 rounded-sm ooutline-none"
