    ...
    <section className="max-padd-container bg-primary rounded-3xl">
      <div className="py-10">
        <table className="w-full mx-auto">
          <thead>
            <tr className="border border-e-tertiary/90 bg-tertiary/90 text-white regular-16 sm:regular-18 text-start py-12">
              ...
              if (cartItems[e.id] > 0) {
                return (
                  <tr key={e.id} className="border-b border-slate-900/20 text-gray-30  p-6 medium-14 text-center">
                    ...
                    <td>
                      <div>
                        <TbTrash className="bold-22 relative left-1/2"
                          onClick={() => {
                            removeFromCart(e.id);
                          }}
                        />
        ...
        {/* Cart Details */}
        <div className="flex flex-col justify-between gap-y-16 mt-10 p-8 md:flex-row roundede-md w-full max-w-[777px]">
          ...
          <div className="flex flex-col gap-10">
            ...
            <div className="flexBetween pl-5 h-[3.3rem] bg-white ring-1 ring-slate-900/10 w-full max-w-[366px] rounded-x;
            ">
              <input type="text" placeholder="Coupon code" className="bg-transparent border-none outline-none"></input>
